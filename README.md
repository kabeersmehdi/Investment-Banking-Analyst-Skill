...
┌──────────────────────────────────────────────────────┐
│ USER INPUT │
│ (Deal data: financials, industry, location, notes) │
└──────────────────┬───────────────────────────────────┘
│
▼
┌──────────────────────────────────────────────────────┐
...
│ ┌─────────────────────────────────────────────┐ │
│ │ Behavioral Rules + Capability Definitions │ │
...
▼ ▼
┌─────────────────┐ ┌──────────────────┐
│ WEB RESEARCH │ │ EMBEDDED LOGIC │
│ (Live Data) │ │ (Fallback) │
│ │ │ │
│ • Industry │ │ • valuation_ │
│ multiples │ │ logic.md │
│ • Market size │ │ • qoe_ │
│ • Active buyers │ │ framework.md │
│ • Recent deals │ │ • deal_ │
│ • SBA rates │ │ structure.md │
│ • Industry │ │ • risk_ │
│ risks │ │ framework.md │
│ │ │ │
│ Governed by: │ │ │
...
│ │ Normalization│ │ Modeling │ │ Assessment │ │
│ │ (QoE) │ │ (Comps+DCF) │ │ │ │
│ └──────────────┘ └──────────────┘ └────────────┘ │
│ │
│ ┌──────────────┐ ┌──────────────┐ ┌────────────┐ │
│ │ Deal │ │ Buyer │ │ Market │ │
│ │ Structuring │ │ Targeting │ │ Intel │ │
│ │ (SBA/Notes) │ │ (Live) │ │ (Live) │ │
│ └──────────────┘ └──────────────┘ └────────────┘ │
└──────────────────┬───────────────────────────────────┘
│
...
┌──────────────────────────────────────────────────────┐
│ SELF-CRITIQUE LOOP │
│ 1. Check for missing data gaps │
│ 2. Verify all sources are cited │
│ 3. Validate valuation logic consistency │
│ 4. Confirm embedded benchmarks are flagged │
│ 5. Check source freshness (<18 months) │
│ 6. Refine narrative for buyer credibility │
│ 7. Finalize + append master source log │
└──────────────────┬───────────────────────────────────┘
│
▼
┌──────────────────────────────────────────────────────┐
│ STRUCTURED OUTPUT │
│ │
│ • Valuation Summary (with sources + confidence) │
│ • CIM (with live industry data) │
│ • Teaser (anonymized) │
│ • Buyer List (with live acquirer research) │
│ • Risk Report (with mitigation narratives) │
│ • Deal Structure Model (SBA / seller note / earnout)│
│ • LOI Evaluation (when offers received) │
│ • Master Source Log │
└──────────────────────────────────────────────────────┘
